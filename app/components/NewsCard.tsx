  ...
  return (
    <Link href={`/post/${id}`}>
      <div className="bg-white rounded-12 border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
        {/* 이미지 영역 */}
        {imageUrl && (
          <div className="w-full h-40 sm:h-48 md:h-56 bg-gray-100 flex items-center justify-center overflow-hidden">
        ...
        {ideologyStats && ideologyStats.total > 0 && (
          <div className="px-4 sm:px-6 pb-3 sm:pb-4">
            ...
            <div className="flex h-2 sm:h-3 w-full rounded overflow-hidden">
