    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-auto bg-gradient-to-b from-gray-100 to-white relative">
        ...
        <div className="w-full max-w-7xl mx-auto pt-4 md:pt-10 px-4 md:px-6">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 text-left font-pretendard">보도 사각지대</h1>
          <p className="text-sm md:text-base text-gray-500 text-left font-pretendard">언론에서 덜 다뤄진 이슈들을 확인하세요.</p>
        </div>
        {/* 중앙 카드 */}
